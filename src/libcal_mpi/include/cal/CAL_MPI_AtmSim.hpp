...
#ifndef CAL_MPI_ATM_SIM_HPP
#define CAL_MPI_ATM_SIM_HPP
...
/**
* \class mpi_atm_sim
* \brief Atmosphere creation, evolution and observation with MPI support
*/
class mpi_atm_sim{
    public:
...
#endif // End of  CAL_MPI_ATM_SIM Class
