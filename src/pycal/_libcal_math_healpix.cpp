...
void init_math_healpix(py::module & m) {
    m.def(
        "healpix_ang2vec", [](py::buffer theta, py::buffer phi,
            ...
            cal::healpix_ang2vec(info_theta.size, rawtheta, rawphi, rawvec);
            return;
    ...
    m.def(
        "healpix_vec2ang", [](py::buffer vec, py::buffer theta,
            ...
            double * rawphi = reinterpret_cast <double *> (info_phi.ptr);
            double * rawvec = reinterpret_cast <double *> (info_vec.ptr);
            cal::healpix_vec2ang(info_theta.size, rawvec, rawtheta, rawphi);
            return;
    ...
    m.def(
        "healpix_vecs2angpa", [](py::buffer vec, py::buffer theta,
            ...
            double * rawvec = reinterpret_cast <double *> (info_vec.ptr);
            cal::healpix_vecs2angpa(info_theta.size, rawvec, rawtheta, rawphi, rawpa);
            return;
    ...
    py::class_ <cal::HealpixPixels, cal::HealpixPixels::puniq> (
        m, "HealpixPixels",
        R"(
    ...
    .def("reset", &cal::HealpixPixels::reset, py::arg(
             "nside"), R"(
    ...
    .def("ang2nest", [](cal::HealpixPixels & self, py::buffer theta,
    ...
    .def("ang2ring", [](cal::HealpixPixels & self, py::buffer theta,
                        py::buffer phi, py::buffer pix) {
             pybuffer_check_1D <double> (theta);
             pybuffer_check_1D <double> (phi);
             pybuffer_check_1D <int64_t> (pix);
    ...
    .def("vec2nest", [](cal::HealpixPixels & self, py::buffer vec,
                        py::buffer pix) {
             pybuffer_check_1D <double> (vec);
             pybuffer_check_1D <int64_t> (pix);
             py::buffer_info info_vec = vec.request();
    ...
    .def("vec2ring", [](cal::HealpixPixels & self, py::buffer vec,
                        py::buffer pix) {
             pybuffer_check_1D <double> (vec);
             pybuffer_check_1D <int64_t> (pix);
             py::buffer_info info_vec = vec.request();
    ...
    .def("ring2nest", [](cal::HealpixPixels & self, py::buffer in,
                         py::buffer out) {
    ...
    .def("nest2ring", [](cal::HealpixPixels & self, py::buffer in,
                         py::buffer out) {
             pybuffer_check_1D <int64_t> (in);
             pybuffer_check_1D <int64_t> (out);
             py::buffer_info info_in = in.request();
    ...
    .def("degrade_ring", [](cal::HealpixPixels & self, int factor,
    ...
    .def("degrade_nest", [](cal::HealpixPixels & self, int factor,
                            py::buffer in, py::buffer out) {
             pybuffer_check_1D <int64_t> (in);
             pybuffer_check_1D <int64_t> (out);
             py::buffer_info info_in = in.request();
    ...
    .def("upgrade_ring", [](cal::HealpixPixels & self, int factor,
                            py::buffer in, py::buffer out) {
             pybuffer_check_1D <int64_t> (in);
             pybuffer_check_1D <int64_t> (out);
             py::buffer_info info_in = in.request();
    ...
    .def("upgrade_nest", [](cal::HealpixPixels & self, int factor,
                            py::buffer in, py::buffer out) {
             pybuffer_check_1D <int64_t> (in);
             pybuffer_check_1D <int64_t> (out);
             py::buffer_info info_in = in.request();
