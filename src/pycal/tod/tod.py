...
class TODCache(TOD):
    ...
    def __init__(
        ...
        self._pref_detdata = self.SIGNAL_NAME + "_"  # "cal_tod_detdata_"
        self._pref_detflags = self.FLAG_NAME + "_"  # "cal_tod_detflags_"
        self._pref_detpntg = "cal_tod_detpntg_"
        self._bore = "cal_boresight"
        self._bore_azel = "cal_boresight_azel"
        self._common = self.COMMON_FLAG_NAME  # "cal_tod_common_flags"
        self._stamps = self.TIMESTAMP_NAME  # "cal_tod_stamps"
        self._pos = "cal_tod_pos"
        self._vel = "cal_tod_vel"
